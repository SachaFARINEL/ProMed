                ...
                <div class="card  my-1" style="min-height: 6rem">
                    ...
                    ?>
                        ...
                        ?>
                            ...
                            if (Controllers\Utils::isRDVAnnule($isAnnule)) {
                            ?>
                                <p><span> Le rendez-vous est annulé <img style="width:3%; margin-left: 0.2rem" src="./assets/images/check.png" </span></p>
                            <?php
                            } else {
                            ?>
                                <p class="pClicked" id="p<?= $compteur ?>"><span class="annulerRDV" id="<?= $id_praticien . '/' . $date ?>"> Annuler ce rendez-vous <img style="width:3%; margin-left: 0.2rem" src="./assets/images/close.png" </span></p>
                            <?php
                            }
                            ?>
