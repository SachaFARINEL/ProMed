            ...
            <div>
                <form action=".?controller=patient&task=save" method="POST">
                    <div class="row g-3">
                        ...
                        <!-- Mettre un système de mot de passe aléatoire ou basé sur le nom et prénom du patient ? -->
                        ...
                        <div class="col-sm-4">
                            <div class="input-group has-validation">
                                ...
                                <input type="text" class="form-control" name="num_secu" id="num_secu" required>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="input-group has-validation">
                                ...
                                <input type="text" class="form-control" name="mutuelle" id="mutuelle">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="input-group has-validation">
                                ...
                                <input type="text" class="form-control" name="caisse" id="caisse">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="input-group has-validation">
                                ...
                                <input type="text" class="form-control" name="prenom_tuteur" id="prenom_tuteur">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="input-group has-validation">
                                ...
                                <input type="text" class="form-control" name="nom_tuteur" id="nom_tuteur">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="input-group has-validation">
                                ...
                                <input type="text" class="form-control" name="mail_tuteur" id="mail_tuteur">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="input-group has-validation">
                                <span class="input-group-text font-monospace">Numéro de voie</span>
                                <input type="text" class="form-control" name="numero_tuteur" id="numero_tuteur">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="input-group has-validation">
                                <span class="input-group-text font-monospace">Adresse</span>
                                <input type="text" class="form-control" name="adresse_tuteur" id="adresse_tuteur">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-2">
                            <div class="input-group has-validation">
                                <span class="input-group-text font-monospace">Code postal</span>
                                <input type="text" class="form-control" name="code_postal_tuteur" id="code_postal_tuteur">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="input-group has-validation">
                                <span class="input-group-text font-monospace">Ville</span>
                                <input type="text" class="form-control" name="ville_tuteur" id="ville_tuteur">
                            </div>
                        </div>
                        ...
                        <div class="col-4">
                            <div class="input-group has-validation">
                                <span class="input-group-text font-monospace">Département</span>
                                <select class="form-select" name="departement_tuteur" id="departement_tuteur">
                                    <option value="">Choisir...</option>
                                    <option value="1">1 - Ain</option>
                                    <option value="2">2 - Aisne</option>
                                    <option value="3">3 - Allier</option>
                        ...
                        <div class="col-sm-3">
                            <div class="input-group has-validation">
                                <span class="input-group-text font-monospace">Pays</span>
                                <input type="text" class="form-control" name="pays_tuteur" id="pays_tuteur">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="input-group has-validation">
                                <span class="input-group-text font-monospace">Prénom</span>
                                <input type="text" class="form-control" name="prenom_generaliste" id="prenom_generaliste">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="input-group has-validation">
                                <span class="input-group-text font-monospace">Nom</span>
                                <input type="text" class="form-control" name="nom_generaliste" id="nom_generaliste">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="input-group has-validation">
                                <span class="input-group-text font-monospace">Email</span>
                                <input type="text" class="form-control" name="mail_generaliste" id="mail_generaliste">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="input-group has-validation">
                                <span class="input-group-text font-monospace">Code postal</span>
                                <input type="text" class="form-control" name="code_postal_generaliste" id="code_postal_generaliste">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="input-group has-validation">
                                <span class="input-group-text font-monospace">Ville</span>
                                <input type="text" class="form-control" name="ville_generaliste" id="ville_generaliste">
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="input-group has-validation">
                                <span class="input-group-text font-monospace">Département</span>
                                <select class="form-select" name="departement_generaliste" id="departement_generaliste">
                                    <option value="">Choisir...</option>
                                    <option value="1">1 - Ain</option>
                                    <option value="2">2 - Aisne</option>
                                    <option value="3">3 - Allier</option>
